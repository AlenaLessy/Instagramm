...
final class HomeInstagamViewController: UIViewController {
    ...
    private enum Constants {
        ...
        static let milkmanPhotoImageName = "mi6"
        static let milkmanNickName = "Торопыжка"
        static let milkmanImageName = "m5"
        static let milkmanPost = "На отдыхе!"
        static let gubkaPhotoImageName = "mi7"
        static let gubkaNickName = "Медвежуля"
        static let gubkaImageName = "m2"
        static let gubkaPost = "Моя любимая фотография"
        static let gomerPhotoImageName = "mi8"
        static let gomerNickName = "Потапыч"
        static let gomerImageName = "m6"
